...
minimapContainer.style.height = `${244 + 2 * padding}px`;
minimapContainer.style.width = `${244 + 2 * padding}px`;
...
minimap.style.width = '244px';
minimap.style.height = '244px';
...
hudSkinMinimap.style.marginLeft = `${244 + 2 * padding}px`;
